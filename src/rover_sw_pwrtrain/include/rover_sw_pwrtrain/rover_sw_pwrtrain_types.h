...
#ifndef rover_sw_pwrtrain_types_h_
#define rover_sw_pwrtrain_types_h_
#include "rtwtypes.h"
...
/* Custom Type definition for MATLABSystem: '<S10>/SourceBlock' */
...
typedef struct tag_RTM_rover_sw_pwrtrain_T RT_MODEL_rover_sw_pwrtrain_T;

#endif                                 /* rover_sw_pwrtrain_types_h_ */
